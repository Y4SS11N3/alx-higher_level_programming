...
"""Defines Unittests for the rectangle.py module."""
import io
import sys
import unittest
...
class TestRectangle_instantiation(unittest.TestCase):
    """Unittests for verifying instantiation
    behavior of the Rectangle class."""
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for validating initialization
    of the Rectangle class's width attribute."""
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for validating initialization of
    the Rectangle class's height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for validating initialization of
    the Rectangle class's x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Unittests for validating initialization of
    the Rectangle class's y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests for verifying the order of
    attribute initialization in the Rectangle class."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for the __str__ and display methods of the Rectangle class."""

    @staticmethod
    def capture_stdout(rect, method):
        """Capture and return stdout output from a Rectangle method call.

        Args:
            rect (Rectangle): Rectangle instance to print.
            method (str): Method of 'rect' to execute and capture output.

        Returns:
            str: Output from stdout after executing 'method' on 'rect'.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittests for the update method using args in the Rectangle class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests for the update method using kwargs in the Rectangle class."""
